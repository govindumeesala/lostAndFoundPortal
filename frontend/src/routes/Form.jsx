...
const Form = () => {
  ...
  useEffect(() => {
    ...
    localISOTime = localISOTime.substring(0, localISOTime.lastIndexOf(":"));
  ...
  const defaultFormData = {
    ...
    itemTag: "",
    type: "Lost",
    dateTime: localISOTime.substring(0, localISOTime.lastIndexOf(":")),
  };
  ...
  const initialFormData = sessionStorage.getItem("formData")
  ...
  const handleSubmit = async () => {
    ...
    try {
      await Axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/report/form`,
